...
class ShowTest < Test::Unit::TestCase
    def test_show #Will pass if the name of the show is the same as set - "Silicon Valley"
        seasons = [Season.new('Silicon Valley', 1, [Episode.new('Silicon Valley', 1, 1), Episode.new('Silicon Valley', 1, 2), Episode.new('Silicon Valley', 1, 3), Episode.new('Silicon Valley', 1, 4)])]
        show = Show.new('Silicon Valley', "Comedy", seasons)
