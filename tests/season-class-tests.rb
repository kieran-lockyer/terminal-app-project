...
class SeasonTest < Test::Unit::TestCase
    def test_show #Will pass if the name of the show is the same as set - "Silicon Valley"
        season = Season.new('Silicon Valley', 1, 4, [Episode.new('Silicon Valley', 1, 1), Episode.new('Silicon Valley', 1, 2), Episode.new('Silicon Valley', 1, 3), Episode.new('Silicon Valley', 1, 4)])
